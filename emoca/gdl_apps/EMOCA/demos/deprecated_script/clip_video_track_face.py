...
def process_clips(annotations_file, input_frames_dir, input_emoca_dir, output_videos_dir, frame_rate=30, bit_rate='200', sorted_sizes=None, sorted_centers=None):
...
def process_video(video_dir, video_name, output_dir):
    ...
    print(f"正在处理: {video_dir}/{video_name}")  # 输出正在处理的video_dir
...
root_dir = '/home/zyude/human_video_data/bilibili_emoca'
output_base_dir = '/home/zyude/human_video_data/results_test'
max_workers = 1  # 设置最大并发数为8
    ...
    for videos_list in os.listdir(root_dir):
        ...
        if os.path.isdir(video_dir):
            ...
            for video_name in video_list:
                ...
                # if os.path.exists(output_dir) or video_name == 'BV1oz421e7ww':
                #     print(f"跳过已处理的视频: {video_name}")
                #     continue
                if video_name != 'BV1pT421r7fN':
                    continue
