...
def parse_args():
    ...
    parser.add_argument('--input_video', type=str, default=str(Path(gdl.__file__).parents[1] / "/home/zyude/human_video_data/bilibili/141248/BV1C7411H7V5.mp4"), 
    ...
    parser.add_argument('--output_folder', type=str, default="/home/zyude/video_output", help="Output folder to save the results to.")
