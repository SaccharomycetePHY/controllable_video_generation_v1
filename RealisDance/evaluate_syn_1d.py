...
from src.utils.util_syn_fc import get_distributed_dataloader, save_videos_grid, sanity_check
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="eval_outputs_1d")
    parser.add_argument("--ckpt", type=str, default="/storage/zouyude/RealisDance/stage1_syn-2024-12-30T23/checkpoints/checkpoint-iter-200000.ckpt")
    ...
    exp_config["output_dir"] = os.path.join(args.output, "stage1_syn/100000/eval",str(exp_config["global_seed"]))
