...
from src.models.pose_guider_normal import PoseGuider
...
class RealisDanceUnet(nn.Module):
    ...
    def forward(
        ...
        if self.image_finetune:
            pose_emb = self.pose_guider(hamer=hamer, smpl=smpl, normal=normal)
            ...
            pose_emb = self.pose_guider(hamer=hamer, smpl=smpl, normal=normal, video_length=video_length,
