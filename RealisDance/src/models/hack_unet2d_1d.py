...
class HackUNet2DConditionModel(UNet2DConditionModel):
    ...
    def init_temporal_crossattention(self):
        ...
        for i in range(len(self.down_blocks)):
            ...
            # setattr(block, "pose_norm", torch.nn.LayerNorm(block.resnets[-1].conv2.out_channels))
        ...
        # setattr(self.mid_block.resnets[0], "pose_norm", torch.nn.LayerNorm(self.mid_block.resnets[0].conv2.out_channels))
