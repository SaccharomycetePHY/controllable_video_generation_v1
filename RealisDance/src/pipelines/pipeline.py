...
class RealisDancePipeline(DiffusionPipeline):
    ...
    def _encode_ground(self, bg_image, fg_image):
        with torch.no_grad():
    ...
    def check_inputs(self, hamer, smpl, ref_image, ref_image_clip, height, width, callback_steps):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.check_inputs(hamer, smpl, ref_image, ref_image_clip, height, width, callback_steps)
        ...
        bg_latents, fg_latents = self._encode_ground(bg_image, fg_image)
            ...
            for i, t in enumerate(timesteps):
                ...
                if self.image_finetune:
                    noise_pred = self.unet(
                        ...
                        # pose=pose, 
                        hamer=hamer, smpl=smpl, timestep=t,
                    ...
                    for c in context_queue:
                        ...
                        noise_pred[:, :, c] += self.unet(
                            ...
                            # pose=partial_pose, 
                            hamer=partial_hamer, smpl=partial_smpl, timestep=t,
                            encoder_hidden_states=clip_latents, drop_reference=False,
                        ).sample.to(dtype=latents_dtype)
                        counter[:, :, c] += 1
