...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="/storage/zouyude/RealisDance/stage1_syn-2024-12-30T23/checkpoints/checkpoint-iter-120000.ckpt")
    ...
    base_dir = "/zouyude/data/infer_sample"
    ...
    for subdir in os.listdir(base_dir):
        ...
        exp_config["output_dir"] = os.path.join(args.output, "infer_sample_mask")
        ...
        exp_config["normal_path"] = os.path.join(base_path, "normal_cover.mp4") 
