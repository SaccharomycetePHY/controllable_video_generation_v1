...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="checkpoint/checkpoint-iter-110000.ckpt")
    ...
    base_dir = "/zouyude/data/data_one_person/eval"
    ...
    for _ in range(100):
        ...
        exp_config["output_dir"] = os.path.join(args.output, "infer_sample_syn_2")
