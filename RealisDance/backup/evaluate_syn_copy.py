...
from src.utils.util_syn_copy import get_distributed_dataloader, save_videos_grid, sanity_check
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="outputs/stage1_syn-2024-12-11T20/checkpoints/checkpoint-iter-100000.ckpt")
    ...
    exp_config["output_dir"] = os.path.join(args.output, "stage1_syn_copy/100000/eval",str(exp_config["global_seed"]))
