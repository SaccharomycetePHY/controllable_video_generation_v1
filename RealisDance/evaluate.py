...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="outputs/stage1_hamer-2024-10-14T18/checkpoints/checkpoint-iter-10000.ckpt")
    ...
    exp_config["output_dir"] = os.path.join(exp_config["output_dir"], "one_person_all_data/20000",str(exp_config["global_seed"]))
