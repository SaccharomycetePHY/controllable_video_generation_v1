...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="outputs/stage2_syn-2024-12-09T00/checkpoints/checkpoint-iter-100000.ckpt")
    ...
    base_dir = "/zouyude/data/mimo_video"
    ...
    for subdir in os.listdir(base_dir):
        ...
        exp_config["output_dir"] = os.path.join(args.output, "mimo_results_with_syn")
        ...
        exp_config["ref_image_path"] = os.path.join(base_path, f"ref5.png")
