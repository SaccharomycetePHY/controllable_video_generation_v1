...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-i', '--video', type=str, default='/amax/zyude/sample_video_/BV1FT411A7yz/clip_440-626/frames', help='Path of the input video or image folder.')
    parser.add_argument(
        '-m', '--mask', type=str, default='/amax/zyude/sample_video_/BV1FT411A7yz/clip_440-626/object_mask', help='Path of the mask(s) or mask folder.')
    parser.add_argument(
        '-o', '--output', type=str, default='results5', help='Output folder. Default: results')
    parser.add_argument(
