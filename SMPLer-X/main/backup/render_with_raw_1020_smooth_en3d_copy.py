...
def visualize_seqs(args):
    ...
    root_folder = f"/amax/zyude/En3d_data/En3d/dataset_En3d_fixcam/{args.cam_view}"
    print('start')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cam_view',type=str,default="")

    args = parser.parse_args()
    print(f"gpu:{args.gpu}")
    print(f"cam_view:{args.cam_view}")
